...
public class RoomBO3 extends JFrame {
	...
	public RoomBO3(Socket client, Player player) throws IOException {
...
//							loading2.setIcon(new ImageIcon(GameRoom.class.getResource("/view/Ellipsis-1s-70px.gif")));
		...
		sms_bo3 = new JTextField();
		sms_bo3.getDocument().addDocumentListener(new DocumentListener() {
...
//				playSound1();
		...
		sms_bo3.setFont(new Font("Courier New", Font.BOLD | Font.ITALIC, 10));
		sms_bo3.setBounds(59, 0, 186, 49);
		panel_2.add(sms_bo3);
		sms_bo3.setColumns(10);
...
//	public void endonegame() throws IOException {
//		if (scoreX == SCORE || scoreO == SCORE) {
//			losebo3();
//			endbo3();
//		}else {
//			write("end-one-game");
